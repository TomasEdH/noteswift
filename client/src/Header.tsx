  ...
  return (
    <div className="pt-10 flex justify-around">
      ...
      <div className="flex items-center gap-x-5">
        ...
        {!user?.user && (
          <div>
            <Link to="/login" className="dark:text-white bg-primary/85 hover:bg-primary focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Login</Link>
            <Link to="/signup" className="dark:text-white bg-primary/85 hover:bg-primary focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Register</Link>
          </div>
        )}
      </div>
    </div>
